...
ansible-playbook /vagrant/ansible/gitlab-jenkins-ci-playbook.yml
ansible-playbook /vagrant/ansible-jenkins/setup.yml --extra-vars='user=vagrant'
#ansible-playbook /vagrant/ansible-playbook-gitlab/gitlab.yml -u vagrant
